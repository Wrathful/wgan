...
def make_discriminator():
    ...
    model = Sequential()
    if K.image_data_format() == 'channels_first':
        model.add(Convolution2D(64, (5, 5), padding='same', input_shape=(3, 512, 512),name="our_conv_1"))
    else:
        model.add(Convolution2D(64, (5, 5), padding='same', input_shape=(512, 512, 3),name="our_conv_1"))
    model.add(Convolution2D(64, (5, 5), kernel_initializer='he_normal', strides=[2, 2],name="our_conv_2"))
    model.add(MaxPooling2D(pool_size=2,name="our_pool_1"))
    model.add(LeakyReLU())
    model.add(Convolution2D(128, (5, 5), kernel_initializer='he_normal', strides=[2, 2],name="our_conv_3"))
    model.add(LeakyReLU())
    model.add(Convolution2D(128, (5, 5), kernel_initializer='he_normal', strides=[2, 2],name="our_conv_4"))
    model.add(LeakyReLU())
    ...
    model.add(Convolution2D(256, (3, 3), kernel_initializer='he_normal', strides=[2, 2],name="our_conv_6"))
    model.add(LeakyReLU())
