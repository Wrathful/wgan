...
def make_discriminator():
    ...
    model = Sequential()
    if K.image_data_format() == 'channels_first':
        model.add(Convolution2D(64, (4, 4), padding='same', input_shape=(3, 512, 512)))
    else:
        model.add(Convolution2D(64, (4, 4), padding='same', input_shape=(512, 512, 3)))
    model.add(Convolution2D(64, (4, 4), kernel_initializer='he_normal',padding='same', strides=[2, 2]))
